...
model = load_model('D:/MegaProject/venv/Voice/saved_models/urban_sound_classifier.h5')

# Load the saved LabelEncoder
le = joblib.load('D:/MegaProject/venv/Voice/saved_models/label_encoder.pkl')
...
random_file_name = 'D:/MegaProject/venv/Voice/fold2/vikram_frame_2.wav'
